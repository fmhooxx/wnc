      ...
      <view class="QS-tabs-scroll-box">
        ...
        >
          ...
          <view
            ...
            class="boxStyle"
            :style="getDurationStyle +( index===getCurrent?getActiveStyle:getDefaultStyle)"
          ></view>
          {{item.name || item}}
        </view>
        <!-- itemBackground -->
        ...
        >
          <view
            ...
            :style="'transition-duration:' + getDuration + 's;' + 
        ...
        <view
          ...
          class="boxStyle2"
          :style="getLinezIndex + getDurationStyle + 
				'width:' + lW + 'px;' + 
